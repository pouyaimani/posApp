...
int8_t injectOffline() {
    ...
    unsigned char masterKey[16] = {0x8F, 0x16, 0x1C, 0x2B, 0x5F, 0x0E,
                                   0x89, 0x1F, 0xD9, 0x43, 0x01, 0x3B,
                                   0xC2, 0xD8, 0x59, 0x09};
    // FB5AE17356401A273D40FC4693373960
    unsigned char logonMacKey[16] = {0xFB, 0x5A, 0xE1, 0x73, 0x56, 0x40,
                                     0x1A, 0x27, 0x3D, 0x40, 0xFC, 0x46,
                                     0x93, 0x37, 0x39, 0x60};
...
STATE_DEF_ENTER(KeyInjection) {
    ...
    Phrases_t id =
        err == ERR_OK ? PHRASE_KEY_INJ_SUCCEED : PHRASE_KEY_INJ_FAILED;
    int8_t infoType = err == ERR_OK ? INFO_SUCCESS : INFO_ERROR;
