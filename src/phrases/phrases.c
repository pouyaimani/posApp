...
// static bool findInJson(const char *phrase, char *out, size_t size, Language_t
// lang) {
//     char *jsonData = MEM_ALLOC(4096);
//     FileErr_t ferr = OOP_CALL(file(), read, PHRASES_JSON_ADDR, jsonData, 0,
//     4096); if (ferr != FILE_ERR_OK) {
...
#define X(id, en, fa) [id] = {.text = {[LNG_EN] = en, [LNG_FA] = fa}},
