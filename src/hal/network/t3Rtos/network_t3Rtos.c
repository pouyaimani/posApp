...
static NetRoute_t getRoute(Network *self) {
    ...
    case SOCKET_ROUTE_WIFI: return NET_ROUTE_WIFI;
    case SOCKET_ROUTE_ETH: return NET_ROUTE_ETH;
    }
}
...
static NetError_t setRoute(Network *self, NetRoute_t route) {
    ...
    case NET_ROUTE_WIFI: sdkRoute = SOCKET_ROUTE_WIFI; break;
    case NET_ROUTE_ETH: sdkRoute = SOCKET_ROUTE_CELLULAR; break;
    default:
...
static int32_t create(Network *self, 
    ...
    case NET_DGRAM: sdkst = SOCKET_DGRAM; break;
