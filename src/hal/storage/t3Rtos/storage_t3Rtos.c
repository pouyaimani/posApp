...
static const SettingItem settingsTable[] = {
    {
        ...
        &_settings.terminal.touchEnable,
    },
    {
        PROP_COMM_MODE,
        T_CHAR,
    ...
    },
    {
        ...
        &_settings.terminal.sleepTimeout,
    },
    {
        PROP_BRIGHTNESS,
        T_CHAR,
    ...
    },
    {
        ...
        101,
        "101",
        &_settings.terminal.loginOperator,
    },
    {
        PROP_LOGIN_DATE,
        T_ASC,
        0,
        sizeof(_settings.terminal.loginDate) - 1,
        "",
    ...
    },
    {
        ...
        (u32) T_ASC,
        15,
        sizeof(_settings.terminal.merchantNo) - 1,
        "",
        _settings.terminal.merchantNo,
    },
    {
        PROP_TERMINAL_NO,
        T_ASC,
        8,
        sizeof(_settings.terminal.terminalNo) - 1,
        "",
        _settings.terminal.terminalNo,
    },
    {
        PROP_MERCHANT_NAME,
        T_ASC,
        0,
        sizeof(_settings.terminal.merchantName) - 1,
        "",
        _settings.terminal.merchantName,
    },
    {
        PROP_WIFI_SSID,
        T_ASC,
        0,
        sizeof(_settings.terminal.wfiSSID) - 1,
        "",
        _settings.terminal.wfiSSID,
    },
    {
        PROP_WIFI_MAC,
        T_ASC,
        0,
        sizeof(_settings.terminal.wifiMac) - 1,
        "",
        _settings.terminal.wifiMac,
    },
    {
        PROP_WIFI_ENC,
        T_INT,
        ...
        0,
        "",
        (void *)&_settings.terminal.wifiEnc,
    },
    {
        PROP_WIFI_PWD,
        T_ASC,
        0,
        sizeof(_settings.terminal.wifiPwd) - 1,
        "",
        _settings.terminal.wifiPwd,
    },
    {
        PROP_APP_ID,
        T_INT,
        ...
        0,
        "",
        (void *) &_settings.terminal.appID,
    },
    {
        PROP_MAIN_SERVER_IP,
        T_ASC,
        0,
        sizeof(_settings.server.mainServerIp) - 1,
        SERVER_IP,
        _settings.server.mainServerIp,
    },
    {
    ...
    },
    {
        ...
        T_ASC,
        0,
        sizeof(_settings.server.backupServerIp) - 1,
        BACKUP_SERVER_IP,
        _settings.server.backupServerIp,
    },
    {
    ...
    },
    {
        ...
        1,
        "0",
        &_settings.server.useBackupAddressFirst,
    },
    {
        PROP_TMS_IP,
        T_ASC,
        0,
        sizeof(_settings.server.tmsIp) - 1,
        TMS_IP,
        _settings.server.tmsIp,
    },
    {
        PROP_TMS_PORT,
        T_INT,
    ...
    },
    {
        ...
        T_ASC,
        0,
        sizeof(_settings.server.tmsBackupIp) - 1,
        TMS_IP,
        _settings.server.tmsBackupIp,
    },
    {
    ...
    },
    {
        ...
        &_settings.terminal.printGreyScale,
    },
    {
        PROP_UPDATE_FLAG,
        T_CHAR,
    ...
    },
    {
        ...
        &_settings.terminal.connectMode,
    },
    {
        PROP_SHIFT_S_DATE,
        T_INT,
