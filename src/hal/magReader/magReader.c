...
static bool isSwiped(MagReader* mag) { return mag->error == MAG_ERR_SWIPED; }

static TrackData_t getTrack1(MagReader* mag) { return mag->data.track1; }

static TrackData_t getTrack2(MagReader* mag) { return mag->data.track2; }

static TrackData_t getTrack3(MagReader* mag) { return mag->data.track3; }
...
static int32_t getCardNoFormTrack(int8_t* track2, int8_t* cardNo,
                                  uint32_t cardNoMaxLen) {
    bool     isTrack2       = false;
