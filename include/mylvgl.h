...
#define LV_SET_BG_OPA(obj, opa) lv_obj_set_style_bg_opa(obj, opa, LV_PART_MAIN)
...
#define LV_HIDE_BORDER_SIDE(obj, border)                                       \
    lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_FULL & ~border,           \
                                 LV_PART_MAIN);
...
#define LV_CLICKABLE(obj) lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE)

#define LV_CHECKABLE(obj) lv_obj_add_flag(obj, LV_OBJ_FLAG_CHECKABLE)
...
#define LV_SET_SIZE(obj, w, h) lv_obj_set_size(obj, w, h)

#define LV_SET_WIDTH(obj, w) lv_obj_set_width(obj, w)

#define LV_GET_WIDTH(obj) lv_obj_get_width(obj)

#define LV_SET_HEIGHT(obj, h) lv_obj_set_height(obj, h)

#define LV_GET_HEIGHT(obj) lv_obj_get_height(obj)

#define LV_AUTO_WIDTH(obj) lv_obj_set_width(obj, LV_SIZE_CONTENT)

#define LV_AUTO_HEIGHT(obj) lv_obj_set_height(obj, LV_SIZE_CONTENT)

#define LV_AUTO_SIZE(obj) lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT)

#define LV_SET_X(obj, x) lv_obj_set_x(obj, x)

#define LV_SET_Y(obj, y) lv_obj_set_y(obj, y)
...
#define LV_SET_ROW_PAD(obj, pad) lv_obj_set_style_pad_row(obj, pad, 0)

#define LV_SET_COLUMN_PAD(obj, pad) lv_obj_set_style_pad_column(obj, pad, 0)
...
#define LV_SET_ALIGN(obj, align) lv_obj_set_align(obj, (lv_align_t)(align))

#define LV_ALIGN(obj, align, x, y) lv_obj_align(obj, (lv_align_t)(align), x, y)
...
#define LV_SET_FLEX_ALIGN(obj, main, cross, track)                             \
    lv_obj_set_flex_align(obj, (lv_flex_align_t)(main),                        \
...
#define LV_SCROLL_DISABLE(obj) lv_obj_remove_flag(obj, LV_OBJ_FLAG_SCROLLABLE)

#define LV_CLICK_DISABLE(obj) lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICKABLE)

#define LV_CLICK_ENABLE(obj) lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE)

#define LV_DRAG_DISABLE(obj) lv_obj_clear_flag(obj, LV_OBJ_FLAG_DRAGABLE)

#define LV_DRAG_ENABLE(obj) lv_obj_add_flag(obj, LV_OBJ_FLAG_DRAGABLE)

#define LV_SCROLL_TO_VIEW(obj) lv_obj_scroll_to_view(obj, LV_ANIM_ON)

#define LV_HIDE(obj) lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN)

#define LV_SHOW(obj) lv_obj_clear_flag(obj, LV_OBJ_FLAG_HIDDEN)
...
#define LV_ENABLE(obj) lv_obj_clear_state(obj, LV_STATE_DISABLED)

#define LV_DISABLE(obj) lv_obj_add_state(obj, LV_STATE_DISABLED)

#define LV_CLEAN(obj) lv_obj_clean(obj)
...
#define LV_PARENT(obj) lv_obj_get_parent(obj)

#define LV_ADD_EV_CB(obj, cb, ev, data) lv_obj_add_event_cb(obj, cb, ev, data)

#define LV_DELETE(obj) lv_obj_delete(obj)
