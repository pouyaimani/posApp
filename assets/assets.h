...
#define ICON_BAT_LEV_LOW            getImgAddr("img_bat_low")
#define ICON_BAT_LEV_1              getImgAddr("img_bat_1")
#define ICON_BAT_LEV_2              getImgAddr("img_bat_2")
#define ICON_BAT_LEV_3              getImgAddr("img_bat_3")
...
#define ICON_WIFI_STRENGTH_0        getImgAddr("img_wifi_0")
...
#define ICON_WIFI_DISCONNECT        getImgAddr("img_wifi_dis")
