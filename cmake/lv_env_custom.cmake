...
# ================= EMBEDDED SAFETY =================
option(LVGL_ENABLE_CPP "Enable C++ support in LVGL" OFF)
option(LVGL_ENABLE_THORVG "Enable ThorVG (requires C++)" OFF)

if(LVGL_ENABLE_CPP)
    enable_language(CXX)
endif()

if(CONFIG_LV_USE_THORVG_INTERNAL AND NOT LVGL_ENABLE_CPP)
    message(FATAL_ERROR "ThorVG requires C++ but LVGL_ENABLE_CPP=OFF")
endif()
